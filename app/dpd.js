...
dpd.chanels = dpd("/chanels");
dpd.chanels.on = function(ev, fn) {
  return dpd.on("chanels" + ":" + ev, fn);
}
dpd.chanels.once = function(ev, fn) {
  return dpd.once("chanels" + ":" + ev, fn);
}
dpd.chanels.off = function(ev, fn) {
  return dpd.off("chanels" + ":" + ev, fn);
}
dpd.chanels.rename = function (path, body, fn) {
  dpd.chanels.exec("rename", path, body, fn);
}
