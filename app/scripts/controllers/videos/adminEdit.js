...
angular.module('rokumanv1.1App')
    .controller('VideosEditCtrl', function ($scope, $rootScope, $location, $routeParams, videoSvc,categorySvc,chanelSvc,userSvc) {
        
        var currentUser = $rootScope.currentUser;
        
        // Get the particular video to fill up the form on page load
        var fetchVideo = function () {
            videoSvc.getVideos($routeParams.videoId)
                .then(function (video) {
                    $scope.video = video;
        ...
        $scope.delete = function () {
            videoSvc.deleteVideo($routeParams.videoId)
